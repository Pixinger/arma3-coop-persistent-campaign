/* 
	Erzeugt ein zufällig positioniertes Minenfeld um einen definierten Punkt.
...
[[_minePosX,_minePosY,0], _mineFieldRadius, _mineCount, _types] call fnc_TownSM_CreateMineField;
