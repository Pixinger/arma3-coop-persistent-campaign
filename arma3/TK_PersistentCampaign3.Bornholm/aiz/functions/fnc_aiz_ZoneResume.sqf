...
private _campsField = _zoneData select 1;		// [position, respawns]
...
//==========================================================================================
{
	[_zoneIndex, _x] spawn fnc_aiz_RunGroupCampTown;	
} foreach _campsTown;
...
//==========================================================================================
{
	[_zoneIndex, _x] spawn fnc_aiz_RunGroupCampField;	
} foreach _campsField;
...
//==========================================================================================
{
	[_zoneIndex, _x] spawn fnc_aiz_RunGroupCheckpoint;	
