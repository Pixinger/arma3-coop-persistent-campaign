class PC
{
	...
	class Town
	{
		...
		class TownParam_SetMood {description = "";};
		class TownParam_GetMood {description = "";};
		class TownParam_SetFood {description = "";};
		class TownParam_GetFood {description = "";};
		class TownParam_SetWater {description = "";};
		class TownParam_GetWater {description = "";};
		class TownParam_SetElectricity {description = "";};
		class TownParam_GetElectricity {description = "";};
		class TownParam_SetInjured {description = "";};
		class TownParam_GetInjured {description = "";};
