...
_loadouts = [
	...
	["Ingenieur (Repair)","US_EngineerRepair.sqf"],
	["Ingenieur (Mine)","US_EngineerMine.sqf"],
	["Sanitäter","US_Medic.sqf"],
	["Sanitäter (Funk)","US_MedicRadio.sqf"],
	["PCML","US_PCML.sqf"],
	["Scharfschütze","US_Sniper.sqf"],
	["Beobachter","US_Spotter.sqf"],
	["Unterstüzung","US_Support.sqf"],
