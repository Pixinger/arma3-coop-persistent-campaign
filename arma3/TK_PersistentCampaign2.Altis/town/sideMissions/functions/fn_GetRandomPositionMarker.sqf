...
Parameter:
	...
	safetyBorder: (default = 0)
	allowLand: (default = true)
	allowWater: (default = true)
...
private["_allowLand"];
_allowLand = [_this, 0, true, [true]] call BIS_fnc_param;

private["_allowWater"];
_allowWater = [_this, 0, true, [true]] call BIS_fnc_param;
