...
if (_usetrigger!="NOTRIGGER") then {
	...
	/*PIX auskommentiert: KRON_TRGFlag=-1;*/
	call compile format["%1=false",_flgname];
	/*PIX auskommentiert: call compile format["KRON_TRGFlag=%1;",_trgname];*/
	/*PIX auskommentiert: if (isNil ("KRON_TRGFlag")) then {*/
	/*PIX ist ersatz!: if (isNil ("_trgname")) then {*/
