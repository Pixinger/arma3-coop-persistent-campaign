...
// _THIS
//================================================================================
params ["_zoneIndex", "_aizZoneActiveIndex", "_mortarSite", "_unitClassnames"];
_mortarSite params ["_mortarSitePositionCopy", "_mortarSiteDirection"];
_mortarSitePosition = [_mortarSitePositionCopy select 0, _mortarSitePositionCopy select 1, _mortarSitePositionCopy select 2];
...
_markerNames = [];
{ _markerNames pushBack format["%1_%2", format["markerUMortar%1_%2", _zoneIndex, floor(random 999999)], _foreachindex]; } foreach (units _group);
{
	createMarker [_x, [0,0]];
...
while { _state != STATE_EXIT } do 
{
	...
	//================================================================================
	{
		...
		_mn setMarkerText format["M|%1|%2|%3", _markerCounter, _foreachindex, _zoneIndex];
...
{
	diag_log format["fnc_aiz_RunGroupMortar: Mortar destroyed. zoneIndex=%1 position=%2", _zoneIndex, _mortarSitePosition];
	_mortarSite set [0, []];
};
