...
{
	diag_log format["dialogContent\showModal.sqf: _ladung", _ladung];
	/*-----------------------------------------------------------------*/
	...
	diag_log format["dialogContent\showModal.sqf: _totalLoad", _totalLoad];
	...
	diag_log format["dialogContent\showModal.sqf: _maxLoad", _maxLoad];
	...
	diag_log format["dialogContent\showModal.sqf: _objectTexts", _objectTexts];
	diag_log format["dialogContent\showModal.sqf: _objectCounts", _objectCounts];

	/*-----------------------------------------------------------------*/
	/* Entsprechend der Objektliste die Icons und GuiTexte laden*/
	_objectIcons = [];
	_objectGuiTexts = [];
	diag_log format["dialogContent\showModal.sqf: _objectGuiTexts", _objectGuiTexts];
	diag_log format["dialogContent\showModal.sqf: _objectTexts2", _objectTexts];
	{
