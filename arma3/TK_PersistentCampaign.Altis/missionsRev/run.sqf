...
/* Error Checks */
/*--------------*/
if (_zoneIndex < 0) then { player globalChat format["ERROR: Invalid MissionRev-ZoneIndex %1 (too small)", _zoneIndex]; };
if (_zoneIndex >= pixZones_ZoneCount) then { player globalChat format["ERROR: Invalid MissionRev-ZoneIndex %1 (too large)", _zoneIndex]; };
