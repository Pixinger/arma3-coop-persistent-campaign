/* 
	Diese Funktion erstellt eine KI Gruppe und lässt diese von einer Strasse zur Nächsten patrollieren.
...
/* Das Objekt bewachen */	
[_groupInfos select 0, _zoneIndex, _centerPosition, _radius, _zoneSafetyBorder] call PC_fnc_PatrolRoad;

/* Im Debug die Gruppe mit einem Marker tracken */
if (!isDedicated) then { [_groupInfos select 0, true, "ColorYellow","PR"] spawn PC_fnc_TrackGroup; };
