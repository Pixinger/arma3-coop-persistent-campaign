/* 
	Diese Funktion stellt sicher, dass eine Gruppe eine bestimmte Position "Unterwasser" patrolliert.
...
if (!_result) exitwith {["PC_fnc_PatrolObject failed."] call BIS_fnc_error; false};
