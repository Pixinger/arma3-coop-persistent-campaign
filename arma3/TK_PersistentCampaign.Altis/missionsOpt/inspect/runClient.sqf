...
_currentTask = player createSimpleTask ["Fahrzeug inspizieren"];
_currentTask setSimpleTaskDescription ["Ein verdaechtiges Fahrzeug wurde entdeckt. Inspizieren Sie das Fahrzeug!", "Fahrzeug inspizieren", ""];
